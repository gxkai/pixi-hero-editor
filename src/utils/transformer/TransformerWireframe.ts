...
export class TransformerWireframe extends Graphics {
    ...
    constructor(transformer: Transformer) {
        ...
        this.boxScalingHandles[0].cursor = HANDLE_TO_CURSOR.topCenter as string;
        this.boxScalingHandles[1].cursor = HANDLE_TO_CURSOR.middleRight as string;
        this.boxScalingHandles[2].cursor = HANDLE_TO_CURSOR.bottomCenter as string;
        this.boxScalingHandles[3].cursor = HANDLE_TO_CURSOR.middleLeft as string;
    }
