...
export class Transformer extends Container {
    ...
    public flipEnabled: boolean;
    public id: string;
    public name = "transformer";
    ...
    constructor(options: Partial<ITransformerOptions> = {}) {
        ...
        this.cursor = "move";
        this.flipEnabled = !!options.flipEnabled;
    ...
    protected draw(): void {
        ...
        this.wireframe.clear().lineStyle(thickness, color);
        ...
        const groupBounds =
            targets.length !== 1
                ...
                : Transformer.calculateOrientedBounds(targets[0], tempBounds, this.transformType === "rotate"); // Auto-detect rotation
